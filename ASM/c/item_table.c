...
item_row_t item_table[] = {
    ...
    [0x0E] = ITEM_ROW(0x53, 0, 0x41, 0x0002, 0x0109, 0x5E, no_upgrade, give_trade, 1,  2), // Cojiro
    ...
    [0x1D] = ITEM_ROW(0x53, 0, 0x41, 0x9001, 0x00DA, 0x29, no_upgrade, give_trade, 1, 0), // Pocket Egg
    [0x1E] = ITEM_ROW(0x53, 0, 0x41, 0x000B, 0x0109, 0x44, no_upgrade, no_effect, -1, -1), // Pocket Cucco
    [0x1F] = ITEM_ROW(0x53, 0, 0x41, 0x0003, 0x0141, 0x54, no_upgrade, give_trade, 1, 3), // Odd Mushroom
    [0x20] = ITEM_ROW(0x53, 0, 0x41, 0x0004, 0x0140, 0x53, no_upgrade, give_trade, 1, 4), // Odd Potion
    [0x21] = ITEM_ROW(0x53, 0, 0x41, 0x0005, 0x00F5, 0x40, no_upgrade, give_trade, 1, 5), // Poacher's Saw
    [0x22] = ITEM_ROW(0x53, 0, 0x41, 0x0008, 0x0143, 0x56, no_upgrade, give_trade, 1, 6), // Goron's Sword (Broken)
    [0x23] = ITEM_ROW(0x53, 0, 0x41, 0x0009, 0x0146, 0x57, no_upgrade, give_trade, 1, 7), // Prescription
    [0x24] = ITEM_ROW(0x53, 0, 0x41, 0x000D, 0x0149, 0x5A, no_upgrade, give_trade, 1, 8), // Eyeball Frog
    [0x25] = ITEM_ROW(0x53, 0, 0x41, 0x000E, 0x013F, 0x52, no_upgrade, give_trade, 1, 9), // Eye Drops
    [0x26] = ITEM_ROW(0x53, 0, 0x41, 0x000A, 0x0142, 0x55, no_upgrade, give_trade, 1, 10), // Claim Check
